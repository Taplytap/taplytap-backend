...
export function SupportWhatsAppBubble() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-20 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_40px_rgba(37,211,102,0.28)] transition duration-200 hover:scale-105 hover:bg-[#1ebe5d] focus:outline-none focus:ring-2 focus:ring-[#25D366]/40 focus:ring-offset-2 active:scale-95"
    >
      <svg
        aria-hidden="true"
        className="h-7 w-7"
