...
import { ActivateFacebookPlateForm } from "@/components/ActivateFacebookPlateForm";
...
export default async function ActivateFacebookPage({ params }: PageProps) {
    ...
    <main className="min-h-screen bg-[#F8FAFC] px-5 py-8 sm:px-6">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-xl flex-col justify-center">
        ...
        <h1 className="mt-5 text-4xl font-bold tracking-tight text-ink sm:text-5xl">
          Activa tu placa de Facebook
        </h1>
        <p className="mt-4 text-base leading-7 text-slateText">
          Pega el enlace para compartir tu perfil de Facebook y conecta tu placa a tu cuenta TaplyTap.
        </p>
        ...
        {disabled ? (
          ...
          <ActivateFacebookPlateForm code={code} currentUserEmail={currentUserEmail} />
        )}
      </div>
    </main>
  );
